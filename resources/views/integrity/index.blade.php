...
@section('title', 'Intégrité blockchain')

@section('content')
<div class="mb-4">
    <h1 class="page-title"><i class="bi bi-shield-lock me-2"></i>Intégrité certifiée</h1>
    <p class="page-subtitle">Garantie de l'intégrité du kilométrage et de l'historique d'entretien</p>
</div>

<div class="row g-3 mb-4">
    <div class="col-md-4">
        <div class="glass-card glass-stat text-center">
            <h6>Score global d'intégrité</h6>
    ...
    <div class="col-md-8">
        <div class="glass-card h-100">
            <div class="glass-body">
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        <div class="integrity-feature"><i class="bi bi-speedometer2"></i><strong>Kilométrage</strong><p class="small text-muted-glass mb-0">Chaque relevé est horodaté et hashé on-chain. Toute modification rétroactive est détectée.</p></div>
                    </div>
                    <div class="col-md-4">
...
<div class="glass-card">
    <div class="glass-header"><i class="bi bi-truck me-2"></i>Intégrité par véhicule</div>
        ...
        <table class="table glass-table mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="{{ route('integrity.show', $report['vehicle']) }}" class="btn btn-sm glass-btn-outline">Audit</a></td>
                </tr>
                @endforeach
            </tbody>
        </table>
